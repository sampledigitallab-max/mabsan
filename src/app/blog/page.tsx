...
export const metadata: Metadata = {
  title: "Blog — Ambalaj Sektöründen Haberler ve İçgörüler",
  description:
    "Oluklu mukavva, sürdürülebilir ambalaj, e-ticaret paketleme ve sektör trendleri üzerine Mabsan'ın yazıları. Drupa fuar gözlemleri ve ambalaj çözümleri.",
...
export default function BlogPage() {
  ...
  return (
    <>
      <PageHero title="Blog" />
      <PageIntro
        title="Sektör içgörüleri ve haberler."
        description="Ambalaj sektörü üzerine tecrübelerimizi, trendleri ve Mabsan'dan güncel haberleri paylaşıyoruz."
      />
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col p-5 md:p-6">
                    ...
                    <span className="inline-flex items-center gap-1 text-[11px] font-display text-white/50 group-hover:text-red-bright tracking-[0.2em] uppercase group-hover:gap-1.5 transition-all self-start">
                      Devamını Oku <ArrowUpRight size={12} />
                    </span>
                  </div>
                </Link>
              </Reveal>
