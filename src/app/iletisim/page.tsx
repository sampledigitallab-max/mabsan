...
export const metadata: Metadata = {
  title: "İletişim — İstanbul Maltepe Üretim Tesisi",
  description:
    "Mabsan ile iletişime geçin: +90 (216) 484 18 00 | info@mabsan.com | Büyükbakkalköy Kaşif Sk. No: 15, 34858 Maltepe / İstanbul. Teklif almak için iletişim formu.",
...
export default function IletisimPage() {
  return (
    <>
      ...
      {/* İLETİŞİM — sol info (3 ikon) + sağ form (pill input'lar) */}
        ...
        <div className="container-x">
          <Reveal>
            <h2 className="font-anybody-bold italic text-white text-2xl md:text-3xl lg:text-4xl text-center mb-12 md:mb-16 text-balance">
              İşbirliği ve sorularınız için bizimle iletişime geçin.
            </h2>
          </Reveal>
          ...
          <div className="grid md:grid-cols-[1fr_2fr] gap-10 md:gap-14 items-start">
            ...
            {/* SAĞ — ContactForm (beyaz pill input'lar) */}
            <Reveal delay={0.1}>
              <ContactForm />
            </Reveal>
          </div>
      ...
      {/* GOOGLE MAPS — full-width karanlık satellite görünüm */}
